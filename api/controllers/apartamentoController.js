...
exports.adicionar = async (req,res) => {
    try{
        ...
        const result = await Apartamento.create(req.body)
...
exports.listarTudo = async (req,res) => {
    try{
        const result = await Apartamento.find({})
...
exports.buscaPorId = async (req,res) => {
    try{
        ...
        const result = await Apartamento.findById({_id:req.params.id})
        return res.status(200).json(result)
    } catch(err){
        console.error(err.message)
        return res.status(400).json({message:"ERRO"})
...
exports.apagar = async (req,res) => {
    try{
        ...
        await Apartamento.findByIdAndDelete({_id:req.params.id})
...
exports.atualizar = async (req,res) => {
    try{
        ...
        const result = await Apartamento.findByIdAndUpdate({_id:req.params.id}, req.body)
